...
CUSTOM_KERNEL_DCT = TOKYO_TF_arm64
...
JRD_BUILD_PERSO = true

#Task8226707 add for integrate GMS jiawei.zhou@tcl.com
BUILD_GMS?=yes

##begin modify by bo_liu for 7830946 on 2019/06/04
CUSTOM_HAL_IMGSENSOR = s5k3l6_shinetech_mipi_raw tokyo_tf_ov13b10_mipi_raw gc5035_stech_mono_mipi_raw gc5035_shinetech_mipi_raw tokyo_tf_hi556_mipi_raw
CUSTOM_HAL_LENS = dw9718taf dw9718t2ndaf dummy_lens
CUSTOM_HAL_MAIN2_IMGSENSOR = gc5035_stech_mono_mipi_raw
CUSTOM_HAL_MAIN_BACKUP_IMGSENSOR =
CUSTOM_HAL_MAIN_BACKUP_LENS =
CUSTOM_HAL_MAIN_IMGSENSOR = s5k3l6_shinetech_mipi_raw tokyo_tf_ov13b10_mipi_raw
CUSTOM_HAL_MAIN_LENS = dw9718taf dw9718t2ndaf
CUSTOM_HAL_SUB_BACKUP_IMGSENSOR =
CUSTOM_HAL_SUB_BACKUP_LENS =
CUSTOM_HAL_SUB_IMGSENSOR = gc5035_shinetech_mipi_raw tokyo_tf_hi556_mipi_raw
CUSTOM_HAL_SUB_LENS = dummy_lens
##end modify by bo_liu for 7830946 on 2019/06/04

##begin modify by bo_liu for 7830946 on 2019/06/04
CUSTOM_KERNEL_IMGSENSOR = s5k3l6_shinetech_mipi_raw tokyo_tf_ov13b10_mipi_raw gc5035_stech_mono_mipi_raw gc5035_shinetech_mipi_raw tokyo_tf_hi556_mipi_raw
CUSTOM_KERNEL_IN_POCKET_SENSOR = no
CUSTOM_KERNEL_KPD = kpd
CUSTOM_KERNEL_LEDS = mt65xx
CUSTOM_KERNEL_LENS = dw9718taf dw9718t2ndaf dummy_lens
# CUSTOM_KERNEL_LINEARACCEL_SENSOR = yes
CUSTOM_KERNEL_MAIN2_BACKUP_IMGSENSOR =
CUSTOM_KERNEL_MAIN2_IMGSENSOR = gc5035_stech_mono_mipi_raw
CUSTOM_KERNEL_MAIN_BACKUP_IMGSENSOR =
CUSTOM_KERNEL_MAIN_BACKUP_LENS =
CUSTOM_KERNEL_MAIN_IMGSENSOR = s5k3l6_shinetech_mipi_raw tokyo_tf_ov13b10_mipi_raw
CUSTOM_KERNEL_MAIN_LENS = dw9718taf dw9718t2ndaf
##end modify by bo_liu for 7830946 on 2019/06/04

##begin modify by bo_liu for 7830946 on 2019/06/04
CUSTOM_KERNEL_SUB_BACKUP_IMGSENSOR =
CUSTOM_KERNEL_SUB_BACKUP_LENS =
CUSTOM_KERNEL_SUB_IMGSENSOR = gc5035_shinetech_mipi_raw tokyo_tf_hi556_mipi_raw
MTK_CAM_STEREO_CAMERA_SUPPORT = yes
##end modify by bo_liu for 7830946 on 2019/06/04

#added for indicate operator by chunhui.du begin
TCT_BUILD_OPERATOR = TF
#added for indicate operator by chunhui.du end
BOOT_LOGO = hdplus1520
LCM_HEIGHT = 1520
LCM_WIDTH = 720
MTK_MULTI_SIM_SUPPORT = ss
#add by hui.xiang for sensor
...
#/*RTT Feature config:[syang@tcl.com]---start*/
MTK_RTT_SUPPORT = yes
#/*RTT Feature config:[syang@tcl.com]---end*/

# task8304162 shangpeng.su start
MTK_WFD_SUPPORT = no
# task8304162 shangpeng.su end

# defect8468437 shangpeng.su begin
MTK_WAPI_SUPPORT = no
# defect8468437 shangpeng.su end

# defect8346590/8383604 shangpeng.su@tcl.com begin
KEYMASTER_VERSION = 4.0
# defect8346590/8383604 shangpeng.su@tcl.com end

CONFIG_JRD_SUNWAVE_FINGERPRINT = no
CONFIG_JRD_FINGERPRINT = no

#yibin.yang 8250046 add MTKLogger for user build
MTK_LOG_CUSTOMER_SUPPORT = yes

#Add CXP pack and SBP value by kechun.li for Defect 8222104
ifeq ($(strip $(TARGET_BUILD_MMITEST)),true)
   MTK_CARRIEREXPRESS_PACK = no
else
   MTK_CARRIEREXPRESS_PACK = na_tf
endif

MTK_VILTE_SUPPORT = no
MTK_VIWIFI_SUPPORT = no

#[TCTOPTIMIZE] Added by dingpengzheng for task 8225007 @{
TCT_STORAGE_CLEAN_SUPPORT=yes
#[TCTOPTIMIZE] @}

#Change the MTK_SIM_HOT_SWAP_COMMON_SLOT to "no" for Defect 8332933
MTK_SIM_HOT_SWAP_COMMON_SLOT = no

#begin add by taojiang for modem config 2019/09/18 
MTK_C2K_LTE_MODE = 0
MTK_MD1_SUPPORT = 9
MTK_PROTOCOL1_RAT_CONFIG = Lf/Lt/W/G
MTK_FLIGHT_MODE_POWER_OFF_MD = no
#end add by taojiang for modem config 2019/09/18

#added by tao-huang for 8371233  disable duraspeed for tokyo_tf
MTK_DURASPEED_SUPPORT = no

#added by junbo.cui for 8389509 used for integrated CalendarImporter
MTK_CALENDAR_IMPORTER_APP = yes
#added by mingbo.feng for 8461109  disable mmprofile function for tokyo_tf
MTK_MMPROFILE_SUPPORT = no

#added by xiaoyao for defect 8470179
MTK_DYNAMIC_SBP_LEVEL = 2

# disable it by hengchang.zhao for 8490137, more and more app services is suppressed
MTK_HEAVY_LOADING_SUPPORT = no

# [TCTOPTIMIZE]Defect8524543, Add by fan.yang for prebuilt on eng version
TCT_ENG_PREBUILT_ENABLE = yes
